...
from src.config import SYSTEM_PROMPT, USER_PROMPT
from src.dto import RespostaLLM
...
def get_df_final(ticker: str, df: pd.DataFrame):
    ticker_data = pd.read_parquet(f"data/tickers/{ticker}.parquet").reset_index()
...
if __name__ == "__main__":
    ...
    if ticker:
        ...
        tickers = os.listdir("data/filtragem-llm")
